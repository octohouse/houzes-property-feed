	...
	<tbody>
		<tr>
			...
			<td style="padding-top:20px;">
				...
				<div style="padding:3px 0"><label><input type="radio" name="remove_action" id="remove_action" value="nothing" <?php if ( isset($options['remove_action']) && $options['remove_action'] == 'nothing' ) { echo ' checked'; } ?>> Do nothing</label></div>

				<div style="padding:3px 0"><label><input type="radio" name="remove_action" id="remove_action" value="" <?php if ( !isset($options['remove_action']) || ( isset($options['remove_action']) && $options['remove_action'] == '' ) ) { echo ' checked'; } ?>> Remove from my website by <em>drafting</em> property</label></div>
