			...
			<div class="right-settings">
				...
				<div class="settings-panels">
					...
					<div class="settings-panel" id="emailreports">
						<?php include( dirname(HOUZEZ_PROPERTY_FEED_PLUGIN_FILE) . '/includes/views/admin-settings-settings-email-reports.php' ); ?>
					</div>

					<div class="settings-panel" id="offmarket" style="display:none">
						<?php include( dirname(HOUZEZ_PROPERTY_FEED_PLUGIN_FILE) . '/includes/views/admin-settings-settings-off-market.php' ); ?>
					</div>
