            ...
            $this->items[] = array(
                'col_export_name' => '
                    ...
                    <div class="row-actions">
                        ...
                        ( $export['format'] == 'blm' ? '<span class="edit"><a href="' . admin_url('admin.php?page=houzez-property-feed-export&custom_property_export_cron=houzezpropertyfeedcronhook&preview=' . (int)$key) . '" aria-label="' . __( 'Preview BLM', 'houzezpropertyfeed' ) . '">' . __( 'View BLM', 'houzezpropertyfeed' ) . '</a> | </span> ' : '' )
