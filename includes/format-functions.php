...
function houzez_property_feed_get_import_formats()
{
    ...
    $formats = array(
        ...
        'agestanet' => array(
            'name' => __( 'AgestaNET', 'houzezpropertyfeed' ),
            'fields' => array(
                array(
                    'id' => 'xml_url',
                    'label' => __( 'XML URL', 'houzezpropertyfeed' ),
        ...
        'blm_remote' => array(
            'name' => __( 'BLM - Remote URL', 'houzezpropertyfeed' ),
            'fields' => array(
                array(
                    'id' => 'url',
                    'label' => __( 'URL', 'houzezpropertyfeed' ),
                    'type' => 'text',
                    'tooltip' => __( 'A URL to the BLM or ZIP file you wish to import', 'houzezpropertyfeed' ),
                ),
            ),
            'address_fields' => array( 'ADDRESS_2', 'ADDRESS_3', 'ADDRESS_4', 'TOWN', 'COUNTY' ),
            'taxonomy_values' => array(
        ...
        'bridge' => array(
            'name' => __( 'Bridge (MLS API Provider)', 'houzezpropertyfeed' ),
            'fields' => array(
                array(
                    'id' => 'access_token',
                    'label' => __( 'Access Token', 'houzezpropertyfeed' ),
        ...
        'reapit_foundations' => array(
            ...
            'fields' => array(
                array(
                    'id' => 'customer_id',
                    'label' => __( 'Customer ID', 'houzezpropertyfeed' ),
                    'type' => 'text',
                    'placeholder' => 'e.g. ABC',
                ),
                array(
                ...
                array(
                    'id' => 'sale_statuses',
                    'label' => __( 'Sale Status(es) To Import', 'houzezpropertyfeed' ),
                    'type' => 'multiselect',
                    'options' => array(
                        'forSale' => 'forSale',
                ...
                array(
                    'id' => 'letting_statuses',
                    'label' => __( 'Letting Status(es) To Import', 'houzezpropertyfeed' ),
                    'type' => 'multiselect',
                    'options' => array(
                        'toLet' => 'toLet',
            ...
            'infos' => array_filter( 
                array( 
                    __( 'Please note that, depending on your Reapit subscription, they may charge per API call and will send a monthly invoice for the usage. You will need to contact Reapit to clarify if you will be charged and to notify them where you wish invoices to be sent if this differs from the email address they have on file.', 'houzezpropertyfeed' ), 
                    __( 'You\'ll need to install the <a href="https://marketplace.reapit.cloud/apps/7974a1ed-7c36-4aa2-baef-d7f6da931a26" target="_blank">Property Hive App on the Reapit Marketplace</a> before being able to import properties.', 'houzezpropertyfeed' ) 
                ) 
            ),
        ),
        'reaxml_local' => array(
        ...
        'reaxml_remote' => array(
            'name' => __( 'REAXML - URL', 'houzezpropertyfeed' ),
            'fields' => array(
                array(
                    'id' => 'xml_url',
                    'label' => __( 'XML URL', 'houzezpropertyfeed' ),
        ...
        'resales_online_api' => array(
            'name' => __( 'ReSales Online API', 'houzezpropertyfeed' ),
            'fields' => array(
                array(
                    'id' => 'identifier',
                    'label' => __( 'Identifier', 'houzezpropertyfeed' ),
                    'type' => 'text',
                    'placeholder' => 'xxxxxxx',
                ),
                array(
                ...
                array(
                    'id' => 'filter_ids',
                    'label' => __( 'API Filter ID(s)', 'houzezpropertyfeed' ),
                    'type' => 'text',
                    'tooltip' => __( 'A comma-delimited list of API filter IDs', 'houzezpropertyfeed' ),
                    'placeholder' => 'e.g. 12345, 23456',
                )
            ),
            'address_fields' => array( 'SubLocation', 'Location', 'Area', 'Province' ),
            'taxonomy_values' => array(
                'sales_status' => array(
                    'Available' => 'Available',
                ),
        ...
        'resales_online' => array(
            'name' => __( 'ReSales Online XML', 'houzezpropertyfeed' ),
            'fields' => array(
                array(
                    'id' => 'xml_url',
                    'label' => __( 'XML URL', 'houzezpropertyfeed' ),
        ...
        'sme_professional_json' => array(
            'name' => __( 'SME Professional JSON', 'houzezpropertyfeed' ),
            'fields' => array(
                array(
                    'id' => 'company_id',
                    'label' => __( 'Company ID', 'houzezpropertyfeed' ),
                    'type' => 'text',
                ),
            ),
            'address_fields' => array( 'town', 'address_3', 'address_4' ),
            'taxonomy_values' => array(
                'sales_status' => array(
                    '1' => 'Available',
                    '2' => 'SSTC',
            ...
            'help_url' => 'https://houzezpropertyfeed.com/documentation/managing-imports/formats/sme/'
        ),
        'spark' => array(
            'name' => __( 'Spark (MLS API Provider)', 'houzezpropertyfeed' ),
            'fields' => array(
                array(
                    'id' => 'access_token',
                    'label' => __( 'Access Token', 'houzezpropertyfeed' ),
            ...
            'help_url' => 'https://houzezpropertyfeed.com/documentation/managing-imports/formats/spark/'
        ),
        'street' => array(
        ...
        'trestle' => array(
            'name' => __( 'Trestle (MLS API Provider)', 'houzezpropertyfeed' ),
            'fields' => array(
                array(
                    'id' => 'client_id',
                    'label' => __( 'Client ID', 'houzezpropertyfeed' ),
                    'type' => 'text',
                ),
                array(
                    'id' => 'client_secret',
                    'label' => __( 'Client Secret', 'houzezpropertyfeed' ),
                    'type' => 'text',
                ),
                array(
                    'id' => 'statuses',
            ...
            'help_url' => 'https://houzezpropertyfeed.com/documentation/managing-imports/formats/trestle/'
        ),
        'vaultea' => array(
        ...
        'thinkspain' => apply_filters( 'houzez_property_feed_export_format_options_thinkspain', array(
            ...
            'taxonomy_values' => array(
                'property_type' => array(
                    ...
                    'Cave House' => 'Cave House',
                    'Commercial' => 'Commercial',
                    'Finca/Country House' => 'Finca/Country House',
                    'Flat' => 'Flat',
                    'Garage' => 'Garage',
                    'Hotel' => 'Hotel',
                    'Loft' => 'Loft',
                    ...
                    'Villa' => 'Villa',
                    'Wooden Home' => 'Wooden Home',
                )
            ),
            'help_url' => 'https://houzezpropertyfeed.com/documentation/managing-exports/formats/thinkspain/',
            'warnings' => array_filter( array( $simplexml_warning ) ),
        ) ),
