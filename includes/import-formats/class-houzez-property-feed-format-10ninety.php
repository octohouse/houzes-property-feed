		...
		foreach ( $this->properties as $property )
		{
			...
			if ( $inserted_updated !== false )
			{
				...
				if ( isset($property->PROP_SUB_ID) && !empty((string)$property->PROP_SUB_ID) )
				{
					...
					{
						wp_set_object_terms( $post_id, $taxonomy_mappings[(string)$property->PROP_SUB_ID], "property_type" );
					}
					else
					{
				...
				do_action( "houzez_property_feed_property_imported_10ninety", $post_id, $propert, $this->import_idy );
