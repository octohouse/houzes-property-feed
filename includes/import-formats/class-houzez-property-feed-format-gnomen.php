		...
		foreach ( $this->properties as $property )
		{
			...
			if ( $inserted_updated !== false )
			{
				...
				if ( 
					...
					apply_filters('houzez_property_feed_images_stored_as_urls_gnomen', false, $post_id, $property, $this->import_id) === true
				)
				{
					$urls = array();
				...
				do_action( "houzez_property_feed_property_imported_gnomen", $post_id, $property, $this->import_id, $this->instance_id );
