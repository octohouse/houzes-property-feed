...
class Houzez_Property_Feed_Format_Loop extends Houzez_Property_Feed_Process {
	...
	public function import()
	{
        ...
        $this->properties = apply_filters( "houzez_property_feed_loop_properties_due_import", $this->properties, $this->import_id );
		...
		foreach ( $this->properties as $property )
		{
			...
			if ( $inserted_updated !== false )
			{
				...
				do_action( "houzez_property_feed_property_imported_loop", $post_id, $propert, $this->import_idy );
