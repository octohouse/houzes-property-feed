		...
		foreach ( $this->properties as $property )
		{
			...
			if ( $inserted_updated !== false )
			{
				...
				if ( isset($property->PropertyType) && !empty((string)$property->PropertyType) )
				{
					...
					{
						wp_set_object_terms( $post_id, $taxonomy_mappings[(string)$property->PropertyType], "property_type" );
					}
					else
					{
				...
				do_action( "houzez_property_feed_property_imported_apex27", $post_id, $propert, $this->import_idy );
