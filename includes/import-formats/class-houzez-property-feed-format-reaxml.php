		...
		foreach ( $this->properties as $property )
		{
	        ...
	        if ($property_query->have_posts())
	        {
	            ...
	            while ($property_query->have_posts())
	            {
	                ...
	                $this->log( 'This property has been imported before. Updating it', (string)$property->uniqueID, $post_id );
			...
			if ( $inserted_updated !== false )
			{
				...
				else
				{
					...
					if ( $queued > 0 ) 
					{
						$this->log( $queued . ' photos added to download queue', (string)$property->uniqueID, $post_id );
					}
				...
				do_action( "houzez_property_feed_property_imported_reaxml", $post_id, $property, $this->import_id, $this->instance_id );
