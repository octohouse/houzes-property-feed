		...
		foreach ( $this->properties as $property )
		{
	        ...
	        if ($property_query->have_posts())
	        {
	            ...
	            while ($property_query->have_posts())
	            {
	                ...
	                $this->log( 'This property has been imported before. Updating it', (string)$property->Refnumber, $post_id );
			...
			if ( $inserted_updated !== false )
			{
				...
				do_action( "houzez_property_feed_property_imported_rentman", $post_id, $property, $this->import_id, $this->instance_id );
