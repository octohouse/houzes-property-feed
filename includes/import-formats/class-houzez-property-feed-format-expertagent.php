		...
		foreach ( $this->properties as $property )
		{
			...
			if ( $inserted_updated !== false )
			{
				...
				if ( isset($property->priority) && !empty((string)$property->priority) )
				{
					...
					{
						wp_set_object_terms( $post_id, $taxonomy_mappings[(string)$property->priority], "property_status" );
					}
					else
					{
				...
				if ( isset($property->property_type) && isset($property->property_style) )
				{
					...
					{
						wp_set_object_terms( $post_id, $taxonomy_mappings[$expert_agent_type], "property_type" );
					}
					else
					{
				...
				do_action( "houzez_property_feed_property_imported_expertagent", $post_id, $propert, $this->import_id );
