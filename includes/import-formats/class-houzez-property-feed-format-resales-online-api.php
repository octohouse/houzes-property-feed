...
class Houzez_Property_Feed_Format_Resales_Online_API extends Houzez_Property_Feed_Process {
	...
	public function import()
	{
		...
		foreach ( $this->properties as $property )
		{
	        ...
	        {
	        	$this->log( 'This property has been imported before. Updating it', $property['Reference'] );
			...
			if ( $inserted_updated !== false )
			{
				...
				do_action( "houzez_property_feed_property_imported_resales_online_api", $post_id, $property, $this->import_id );
