		...
		foreach ( $this->properties as $property )
		{
			...
			if ( $inserted_updated !== false )
			{
				...
				if ( isset($property['STATUS_ID']) && !empty($property['STATUS_ID']) )
				{
					...
					{
						wp_set_object_terms( $post_id, $taxonomy_mappings[$property['STATUS_ID']], "property_status" );
					}
					else
					{
				...
				if ( isset($property['PROP_SUB_ID']) && !empty($property['PROP_SUB_ID']) )
				{
					...
					{
						wp_set_object_terms( $post_id, $taxonomy_mappings[$property['PROP_SUB_ID']], "property_type" );
					}
					else
					{
				...
				do_action( "houzez_property_feed_property_imported_blm", $post_id, $propert, $this->import_idy );
